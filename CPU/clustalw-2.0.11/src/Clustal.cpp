...
{   
    ...
    guide_tree_time = clock() - guide_tree_time;
    ...
    FullMSATime = clock() - FullMSATime;
    cout << "pairwise time      : " << dist_time/CLOCKS_PER_SEC << endl;
    //cout << "guide tree time    : " << guide_tree_time/ CLOCKS_PER_SEC << endl;
    //cout << "MSA time           : " << msa_time /CLOCKS_PER_SEC << endl;
    cout << "Full MSA total time: " << FullMSATime /CLOCKS_PER_SEC << endl;
    return;
}
