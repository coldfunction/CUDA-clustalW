...
vector<Sequence> ClustalFileParser::getSeqRange(int firstSeq, int no)
{
...
Sequence ClustalFileParser::getSeq(int seqNum)
{
    char line[MAXLINE + 1];
    line[0] = EOS;
    char tseq[MAXLINE + 1];
