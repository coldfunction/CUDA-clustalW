...
void InteractiveMenu::mainMenu()
{
    while (true)
    {
        ...
        {
            case '1':
                clustalObj->sequenceInput(false); 
                break;
            case '2':
                multipleAlignMenu();
                break;
    ...
    while (true)
    {
        ...
        switch (toupper(choice))
        {
            ...
            case '1':
                ...
                fullaligntime = clock() - fullaligntime;
                cout << "Full alignment time: " << fullaligntime << endl;
                break;
            case '2':
    ...
    while (true)
    {
        ...
        switch (toupper(choice))
        {
            ...
            case '6':
                ...
                if (userParameters->getDNAFlag())
                {
                    userParameters->setKtup(
                                   utilityObject->getInt("Enter number", 1, 4,
                                                  userParameters->getKtup()));
                }
                else
                {
                    userParameters->setKtup(
                                   utilityObject->getInt("Enter number", 1, 2, 
                                   userParameters->getKtup()));
                }
                break;
            case '7':
