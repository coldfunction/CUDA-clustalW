...
//**********************************************************************
    ...
    if (setMaxSeqLen != -1)
    {
        ...
        if((*paramArg)[setMaxSeqLen].length() > 0)
        {
            ...
            {
                cout << "Bad option for /maxseqlen (must be int)\n";
                temp = 0;
            }
        }
        if(temp > 0)
        ...
        {
            cout << "Cannot use a negative value for maximum sequence length. Using default\n";
        }
    ...
    if(setDoIteration != -1)
    {
        ...
        { 
            ...
            {
                cout << "Unknown option for iteration. Setting to NONE\n";
                userParameters->setDoRemoveFirstIteration(NONE);
            }
        }
    }    
        ...
        for (i = 0; cmdLineVerb[i].str[0] != '\0'; i++) 
        {
            ...
            if (cmdLineVerb[i].type == OPTARG) 
            {
                ...
                {     
                    ...
                    for(j = 1; j < cmdLineVerb[i].arg->size() - 1; j++)
                    {
        ...
        for (i = 0; cmdLineFile[i].str[0] != '\0'; i++) 
        {
            ...
            if (cmdLineFile[i].type == OPTARG) 
            {
                if (cmdLineFile[i].arg !=  NULL)
                {
                    ...
                    for(j = 1; j < cmdLineFile[i].arg->size() - 1; j++)
                    {
        ...
        for (i = 0; cmdLinePara[i].str[0] != '\0'; i++) 
        {
            ...
            if (cmdLinePara[i].type == OPTARG) 
            {
                if (cmdLinePara[i].arg !=  NULL)
                {
                    ...
                    for(j = 1; j < cmdLinePara[i].arg->size() - 1; j++)
                    {
...
//********************************************************
    ...
    if(setProfile2 != -1) 
    {
        ...
        {
            cout << "\nBad profile 2 file name\n";
            exit(1);
        }
        if(userParameters->getProfile1Empty()) 
        {
            cout << "\nOnly 1 profile file (profile 2) specified.\n";
            exit(1);
        }
...
//************************************************************************
    ...
    if (setInteractive != -1)
    {
        ...
        if (setQuiet!=-1) {
            cout << "interactive menu: overriding -quiet\n";
            userParameters->setDisplayInfo(true);
            utilityObject->beQuiet(false);
        }
    }
    ...
    if(setTree != -1 )
    {
        ...
        {
            cout << "\nCannot draw tree.  No input alignment file\n";
            exit(1);
        }
        else
        { 
    ...
    if(setBootstrap != -1)
    {
        if(userParameters->getEmpty()) 
        {
            cout << "\nCannot bootstrap tree. No input alignment file\n";
            exit(1);
        }
        else 
        {
            ...
            if((*paramArg)[setBootstrap].length() > 0)
            {
                ...
                {
                    cout << "Bad option for /bootstrap (must be integer)\n";
                    temp = 0;
                }
            }
            if(temp > 0)
    ...
    if(setAlign != -1)
    {
        if(userParameters->getEmpty()) 
        {
            cout << "\nCannot align sequences.  No input file\n";
            exit(1);
        }
        else
        { 
    ...
    if(setConvert != -1)
    {
        if(userParameters->getEmpty()) 
        {
            cout << "\nCannot convert sequences.  No input file\n";
            exit(1);
        }
        else
        { 
    ...
    if(setUseTree != -1)
    {
        ...
        else  
        {
           ...
           {
                cout << "\nCannot align sequences.  No tree file specified\n";
                exit(1);
           }
           else 
           {
    ...
    if(setUseTree1 != -1)
    {
        if(userParameters->getProfile1Empty()) 
        {
            cout << "\nCannot align profiles.  No input file\n";
            exit(1);
        }
        else if(profileType == SEQUENCE) 
        {
            cout << "\nInvalid option /usetree1.\n";
            exit(1);
        }
        else  
        {
            ...
            {
                cout << "\nCannot align profiles.  No tree file specified\n";
                exit(1);
            }
            else 
            {
...
/*
 * The function checkParam is used to put all the parameters and their values in the
 * vectors, and also to check that all parameters that require a value have it.
 */
                                  ...
                                  StringArray* paramArg)
{
    ...
    */
    ...
    {
        cout << "There is something wrong with arguments. Lengths different\n";
        exit(1);
    }
        ...
        for(;;) 
        {
            ...
            if (!(*params)[i].compare(cmdLinePara[j].str))
            {
                ...
                *cmdLinePara[match[i]].flag = i;
                ...
                {
                    cout <<  "Error: parameter required for /" << (*params)[i] << endl;
                    exit(1);
    ...
    */
    for (i = 0; i < num; i++) 
    {
        if (match[i] == -1) 
        {
            cout << "Error: unknown option " << default_commandsep << (*params)[i] << endl;
            exit(1);
        }
    }
    return(num);
...
void CommandLineParser::setOptionalParam()
{
    ...
    if(setNumIterations != -1)
    {
        ...
        if((*paramArg)[setNumIterations].length() > 0)
        {
            ...
            {
                cout << "Bad option for /numiter (must be int)\n";
                temp = 0;
            }
        }
        if(temp > 0)
        ...
        {
            cout << "Cannot use a negative value for number of iterations. Using default\n";
        }
    }
    ...
    if(setSeed != -1) 
    {
        ...
        if((*paramArg)[setSeed].length() > 0)
        {
            ...
            {
                cout << "Bad option for /seed (must be integer)\n";
                temp = 0;
            }
        }
        if(temp > 0)
    ...
    if(setTreeAlgorithm != -1)
    {
        ...
        { 
            ...
            {
                cout << "Unknown option for clustering algorithm. Using default\n";
                userParameters->setClusterAlgorithm(NJ);
            }
        }
    }
    ...
    if(setKtuple != -1) 
    {
        ...
        if((*paramArg)[setKtuple].length() > 0)
        {
            ...
            {
                cout << "Bad option for /ktuple (must be integer)\n";
                _ktup = 0;
            }
        }
    ...
    if(setPairGap != -1) 
    {
        ...
        if((*paramArg)[setPairGap].length() > 0)
        {
            ...
            {
                cout << "Bad option for /pairgap (must be integer)\n";
                _windgap = 0;
            }
            if(_windgap > 0)
            {
                if(userParameters->getDNAFlag()) 
                {
                    if(temp > userParameters->getKtup()) 
                    {
    ...
    if(setTopDiags != -1) 
    {
        ...
        if((*paramArg)[setTopDiags].length() > 0)
        {
            ...
            {
                cout << "Bad option for /topdiags (must be integer)\n";
                _signif = 0;
            }
        }
        if(_signif > 0)
    ...
    if(setWindow != -1) 
    {
        ...
        if((*paramArg)[setWindow].length() > 0)
        {
            ...
            {
                cout << "Bad option for /window (must be integer)\n";
                _window = 0;
            }
        }
        if(_window > 0)
    ...
    if(setMaxDiv != -1) 
    {
        ...
        if((*paramArg)[setMaxDiv].length() > 0)
        {
            ...
            {
                cout << "Bad option for /maxdiv (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 0)
    ...
    if(setGapDist != -1) 
    {
        ...
        if((*paramArg)[setGapDist].length() > 0)
            ...
            {
                cout << "Bad option for /gapdist (must be integer)\n";
                temp = 0;
            }
        if (temp >= 0)
        {
    ...
    if(setDebug != -1) 
    {
        ...
        if((*paramArg)[setDebug].length() > 0)
            ...
            {
                cout << "Bad option for /debug (must be integer)\n";
                temp = 0;
            }
        if (temp >= 0)
        {
    ...
    if(setRange != -1) 
    {
        ...
        if((*paramArg)[setRange].length() > 0)
        {
            ...
            if (sscanf((*paramArg)[setRange].c_str(), "%d%[ :,-]%d", &iFirstRes,
                        &ignore, &iLastRes) != 3) 
            {
                cout << "setRange:  Syntax Error: Cannot set range, should be from:to \n";
            }
            else
            {
    ...
    if(setGapOpen != -1) 
    {
        ...
        if((*paramArg)[setGapOpen].length() > 0)
        {
            ...
            {
                cout << "Bad option for /gapopen (must be real number)\n";
                ftemp = 0.0;
            }
            if(ftemp >= 0.0)
            {
    ...
    if(setGapExtend != -1) 
    {
        ...
        if((*paramArg)[setGapExtend].length() > 0)
        {
            ...
            {
               cout << "Bad option for /gapext (must be real number)\n";
               ftemp = 0.0;
            }
            if(ftemp >= 0)
            {
    ...
    if(setTransWeight != -1) 
    {
        ...
        if((*paramArg)[setTransWeight].length() > 0)
        {
            ...
            {
                cout << "Bad option for /transweight (must be real number)\n";
                ftemp = 0.0;
            }
        }
    ...
    if(setPWGapOpen != -1) 
    {
        ...
        if((*paramArg)[setPWGapOpen].length() > 0)
        {
            ...
            {
                cout << "Bad option for /pwgapopen (must be real number)\n";
                ftemp = 0.0;
            }
        }
        if(ftemp >= 0.0)
    ...
    if(setPWGapExtend != -1) 
    {
        ...
        if((*paramArg)[setPWGapExtend].length() > 0)
        {
            ...
            {
               cout << "Bad option for /pwgapext (must be real number)\n";
               ftemp = 0.0;
            }
        }
        if(ftemp >= 0)
    ...
    if(setHelixGap != -1) 
    {
        ...
        if((*paramArg)[setHelixGap].length() > 0)
        {
            ...
            {
                cout << "Bad option for /helixgap (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 1 && temp <= 9)
    ...
    if(setStrandGap != -1) 
    {
        ...
        if((*paramArg)[setStrandGap].length() > 0)
        {
            ...
            {
                cout << "Bad option for /strandgap (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 1 && temp <= 9)
    ...
    if(setLoopGap != -1) 
    {
        ...
        if((*paramArg)[setLoopGap].length() > 0)
        {
            ...
            {
                cout << "Bad option for /loopgap (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 1 && temp <= 9)
    ...
    if(setTerminalGap != -1) 
    {
        ...
        if((*paramArg)[setTerminalGap].length() > 0)
        {
            ...
            {
                cout << "Bad option for /terminalgap (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 1 && temp <= 9) 
    ...
    if(setHelixEndIn != -1) 
    {
        ...
        if((*paramArg)[setHelixEndIn].length() > 0)
        {
            ...
            {
                cout << "Bad option for /helixendin (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 0 && temp <= 3)
    ...
    if(setHelixEndOut != -1) 
    {
        ...
        if((*paramArg)[setHelixEndOut].length() > 0)
        {
            ...
            {
                cout << "Bad option for /helixendout (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 0 && temp <= 3)
    ...
    if(setStrandEndIn != -1) 
    {
        ...
        if((*paramArg)[setStrandEndIn].length() > 0)
        {
            ...
            {
                cout << "Bad option for /strandendin (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 0 && temp <= 3)
    ...
    if(setStrandEndOut != -1) 
    {
        ...
        if((*paramArg)[setStrandEndOut].length() > 0)
        {
            ...
            {
                cout << "Bad option for /strandendout (must be integer)\n";
                temp = 0;
            }
        }
        if (temp >= 0 && temp <= 3)
