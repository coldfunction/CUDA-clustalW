 ...
 * @return 
 */
double Utility::getReal(char *instr, double minx, double maxx, double def)
{
    int status;
    float ret;
    char line[MAXLINE];
 ...
 * @return 
 */
int Utility::getInt(char *instr, int minx, int maxx, int def)
{
    int ret, status;
    char line[MAXLINE];
 ...
 *
 */
char Utility::promptForYesNo(char *title, char *prompt)
{
    cout << "\n" << title << "\n";
 ...
 *
 */
char Utility::promptForYesNo(const char *title, char *prompt)
{
    cout << "\n" << title << "\n";
    string promptMessage = string(prompt) + "(y/n) ? [y]";
